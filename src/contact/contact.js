export default function Contact() {
    return /*html*/`
    <section id="contact">
        <div class="relative isolate px-6 py-20 lg:px-4">
            <div class="mx-auto max-w-4xl">
                <div id="socials" class="text-center">
                    <div class="mt-4 font-semibold mr-10">
                        Acompanhe nossas redes socias
                    </div>
                    <div class="flex flex-row place-content-center pt-4  text-center">
                        <a href="#" class="border-4 border-green-400 rounded-full p-3 mr-4 bg-white">
